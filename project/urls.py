...
urlpatterns = patterns('',
    ...
    #url(r'^accounts/loggedin/$', 'app.views.loggedin'),
    url(r'^accounts/invalid/$', 'app.views.invalid_login'),
    url(r"^accounts/", include("registration.backends.simple.urls")),
    #url(r'^accounts/register/complete/$', 'app.views.register_success'),
    url(r'^personal/$', app.views.personal_info, name='personal',),
    #url(r'^user/$', 'app.views.user_profile_edit'),
